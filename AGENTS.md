...
- `vp build` - create a production build; also generates initial content artifacts.
...
Review `.env.example` before changing GitHub API, proxy, or search behavior.
