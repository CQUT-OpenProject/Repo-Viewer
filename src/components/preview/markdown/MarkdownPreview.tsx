import React, { useState, useRef, useEffect, type AnimationEvent } from "react";
...
const MarkdownPreview = ({
  ...
  // 检测LaTeX公式数量的回调
  const handleLatexCheck = React.useCallback(() => {
  ...
  const notifyRenderComplete = React.useCallback((): void => {
  ...
  const handleLinkClick = (relativePath: string) => {
  ...
  const handleFadeInAnimationEnd = (event: AnimationEvent<HTMLDivElement>) => {
