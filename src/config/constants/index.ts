...
export const ENV_MAPPING = {
  ...
  LOGGER_LEVEL: "VITE_LOGGER_LEVEL",
...
export const CONFIG_DEFAULTS = {
  ...
  // 代理配置
  DOWNLOAD_PROXY_URL: "https://gh-proxy.com,https://ghproxy.com,https://raw.staticdn.net",
  ...
  SEARCH_INDEX_ASSET_BASE_PATH: "/search-index",
  SEARCH_INDEX_MANIFEST_PATH: "/search-index/manifest.json",
